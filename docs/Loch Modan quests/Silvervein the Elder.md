...
{{Questbox
| name = Silvervein the Elder
| level = {{Level|full}}
| category = Lunar Festival
| start = [[Elder Silvervein]]
...
==Notes==
[[Elder Silvervein]] Is located on a hill next to [[Thelsamar]] at {{co|33.3|46.5|Loch Modan}} in [[Loch Modan]].
