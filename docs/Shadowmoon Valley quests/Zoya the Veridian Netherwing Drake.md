...
{{Questbox
 ...
 | start = [[Zoya]]
 | rewards = [[Reins of the Veridian Netherwing Drake]]
 | id = 11114
 }}

'''Zoya the Veridian Netherwing Drake''' is one of the six [[Netherwing]] {{reputation|exalted}} reward quests players may choose from.
