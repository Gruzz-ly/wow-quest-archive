...
{{Questbox
 ...
 | start = [[Voranaku]]
 | rewards = [[Reins of the Violet Netherwing Drake]]
 | id = 11113
 }}

'''Voranaku the Violet Netherwing Drake''' is one of the six [[Netherwing]] {{reputation|exalted}} reward quests players may choose from.
