# Teron Gorefiend - Lore and Legend (Horde)
...
| start = [[Chief Apothecary Hildagard]]
| end = [[Ancient Shadowmoon Spirit]]
| experience = 6250 (or {{cost|3|75|}} at max level)
| previous = [[Spectrecles (quest)]]
| id = 10633
| other-faction = Teron Gorefiend - Lore and Legend (Alliance)
}}
...
==Rewards==
You will receive:
*6250 [[XP]] (or {{cost|3|75|}} at max level)
