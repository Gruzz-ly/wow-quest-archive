# The Warden's Cage (Aldor)

{{for|the Scryers quest|The Warden's Cage (Scryers)}}
{{Questbox
 | name = The Warden's Cage
 | faction = Aldor
 | level = {{level|Shadowmoon Valley}}
 | category = Shadowmoon Valley
 | start = [[Anchorite Ceyla]]
 | end = [[Sanoru]]
 | reputation = +75 [[Aldor]]
 | experience = 6250
 | previous = [[The Ashtongue Corruptors (Aldor)]]
 | next = [[Proof of Allegiance]]
}}
...
==Completion==
We've been expecting you, <name>.  Akama said you would arrive sooner or later.

==Notes==
[[File:StairwayToSanoru-WardensCage.jpg|thumb|The Warden's Cage from above with a red arrow marking the stairwell to Sanoru.]]
*Sanoru is in an underground chamber below the Warden's Cage.  There is a small stairwell leading down into the chamber at coordinates 57,49. If you have a flying mount, you can just fly up to the top and defeat one demon to get to the stairwell.
