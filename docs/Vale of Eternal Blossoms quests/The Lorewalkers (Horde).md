...
| end=[[Lorewalker Cho]]
| next=[[Your Private Collection]]
|other-faction=The Lorewalkers (Alliance)
}}

== Objectives ==
Speak to {{NPC||Lorewalker Cho}} at the [[Seat of Knowledge]] in the [[Vale of Eternal Blossoms]].
...
== Notes ==
Fly across the [[Summer Fields]] to the [[Mogu'shan Palace]]. On the second level out on the terrace is {{NPC||Mishi}}, outside the door of the [[Seat of Knowledge]]. Run in and speak with Cho.
