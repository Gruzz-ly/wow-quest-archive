...
{{questbox
 ...
 | level = {{level|mop-max}}
 | levelreq = {{level|mop-max}}
 | start = [[Taijing the Cyclone]]
 | end = [[Trial Master Rotun]]
 | experience = 1,370
 | money = {{cost|1|14|}}
 | other-faction = Proving Grounds (Pandaria) (Horde)
}}
...
You look strong.  I've seen you a few times here in the [[Vale of Eternal Blossoms|Vale]], but I've never seen you fight before.  I wonder... are you as strong as you seem?
...
[[Category:Kun-Lai Summit quests]]