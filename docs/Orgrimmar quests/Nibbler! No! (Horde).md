...
| name = Nibbler! No!
| faction = Horde
| level = {{Level|cata zone}}
| type = Daily
| category = Jewelcrafting
| start = [[Marith Lazuria]]
| money = {{cost|16|53|ijt=1}}
|other-faction=Nibbler! No! (Alliance)
}}
This daily quest requires 475 [[Jewelcrafting]]

== Objectives ==
Cut three [[Solid Zephyrite]]s and give them to [[Marith Lazuria]] in [[Orgrimmar]]. 
...
== Notes ==
You need to actually cut the 3 gems ''while on this quest'' to complete it.
