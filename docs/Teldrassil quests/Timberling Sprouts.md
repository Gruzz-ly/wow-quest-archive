...
{{Questbox
 ...
 | category = Teldrassil
 | start = [[Denalan]]
 | reputation= [[Darnassus (faction)|Darnassus]] +350
 | experience = 980 XP
 | rewards = [[Gardening Gloves]] or<br /> [[Graystone Bracers]]
 | money = {{cost||6|}}
 | repeatable = 
 | previous = [[Denalan's Earth]]
 | next = 
 | id = 919
}}
...
{{itembox|You will be allowed to choose one of the following:|Gardening Gloves|Graystone Bracers}}
You will also receive {{cost||6|}}.
...
==Notes==
You will need one inventory spot open to retrieve [[Timberling Sprout]]s, which are required to complete this quest. Timberling Sprouts can be found around [[Lake Al'Ameth]].
