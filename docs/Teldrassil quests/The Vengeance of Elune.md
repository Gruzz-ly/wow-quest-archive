...
{{Questbox
 | id = 14005
 | name = The Vengeance of Elune
 | faction = Alliance
 | category = Teldrassil
 | level = {{level|Teldrassil}}
 | start = [[Tarindrella]] {{co|42.6|58|Teldrassil}}
 | reputation =  +250 [[Darnassus (faction)|Darnassus]]
 | experience = 1050
 | rewards = [[Revitalizing Wristguards]] or<br /> [[Britches of Turning Fortune]] or<br />[[Uncorrupted Hands]] or<br />[[Durable Drape]] or <br />[[Uncorrupted Gloves]] or <br />[[Trousers of Turning Fortune]]
 | money = {{cost||7}}
 | previous = [[Teldrassil: The Coming Dawn]]
 | next = [[The Waters of Teldrassil]]
}}

'''The Vengeance of Elune''' is a [[night elf]] quest in [[Teldrassil]].

==Objectives==
Use the powers granted to you by [[Tarindella]] to fight your way to the Heart of Corruption and destroy it.
* [[Bough of Corruption]] slain

==Description==
As Teldrassil purges itself of the corruption that has perverted it's growth for all of these years, a malevolent growth has formed near the tree's edge, south of here. We have an opportunity to strike out and purge the source of the fel moss that has tainted the gnarlpine, the timberlings, and everything else.

With the water that you've collected from the moonwells and the renewed strength of Teldrassil herself, I can grant you great power for a short while. Put an end to this corruption, <name>.
...
==Progress==
Did you find the source of the corruption?
...
==Patch changes==
*{{Patch 7.0.3|note=Quest rewards updated.}}
