# Shatter the Shards (Horde)

{{Questbox
| name = Shatter the Shards
| id = 13328
...
| experience = 27550
| money = {{cost|7|40}} or {{cost|16|53}} at 80
| previous = [[Before the Gate of Horror (Horde)]]
| other-faction = Shatter the Shards (Alliance)
}}
...
==Rewards==
You will receive:
* {{cost|7|40}} or {{cost|16|53}} at level 80
* 27550 [[XP]]
...
==Completion==
<Koltira takes the crystal shards from you and speaks in a quiet voice.>
...
==Notes==
The Shard of Horror is on top of the ramparts at {{coords|47.7|68.6|Icecrown}}.
The Shard of Despair is on the floor below the top ramparts at {{coords|50|67.6|Icecrown}}.
The Shard of Suffering is on the same floor as the Shard of Despair at {{coords|46|70|Icecrown}}.

==Progression==
{{Sneak Preview|Horde}}

==Patch changes==
*{{Hotfix|date=2009-04-23|bluenote=The quests "Shatter the Shards" and "[[The Guardians of Corp'rethar (Horde)]]" should be completable again whether or not you are involved in [[Argent Tournament]] quests.|link=http://blue.mmo-champion.com/23/16474158165-recent-ingame-fixes--41609.html}}
