# Stop the Ascension! (Horde)

{{questbox
| name=Stop the Ascension!
| start=[[Vrykul Scroll of Ascension]]
| faction=Horde
| id=11260
| level={{level|Howling Fjord}}
| category=Howling Fjord
| end=[[Greatmother Ankha]]
| reputation=+350 [[Warsong Offensive]]
| rewards=[[Supple Doeskin Moccasins]] or [[Shock-Bound Spaulders]] or [[Onyx Grips]] or [[Rejuvenating Cord]]
| experience=25400
| money={{cost|10}}
| next=[[Of Keys and Cages (Horde)]]
|other-faction=Stop the Ascension! (Alliance)
}}
...
== Rewards ==
{{itembox|You will be able to choose one of these rewards|Supple Doeskin Moccasins|Shock-Bound Spaulders|Onyx Grips|Rejuvenating Cord}}
You will also receive: {{cost|10}}
...
== Notes ==
This item will drop from one of the pathing casters. The bonfire is up top. Be certain to bomb the towers on the way up and then fight towards the center. Don't stay in range of the towers in case they respawn! Clear some room, but the whole top area does not need to be devoid of mobs when the scroll is presented.

Script event:
:{{text|yell|Halfdan the Ice-Hearted|You think I do not know what you are trying to do? You think I haven't been watching you?}}
:{{text|yell|Halfdan the Ice-Hearted|You will not stop my ascension, tiny <race>. Time to die!}}

;After his death
:{{text|yell|[[Val'kyr Observer]]|How unfortunate, Halfdan.}}
:{{text|yell|Val'kyr Observer|We find you unworthy of ascension, Halfdan. Let your soul know oblivion!}}
