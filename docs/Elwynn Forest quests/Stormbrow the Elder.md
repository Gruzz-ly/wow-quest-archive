...
{{Questbox
| name = Stormbrow the Elder
| level = {{Level|full}}
| category = Lunar Festival
| start = [[Elder Stormbrow]]
...
==Notes==
*[[Elder Stormbrow]] is located near the pond behind the Forge in [[Goldshire]]{{coords|39.8|63.7|Elwynn Forest}} in [[Elwynn Forest]].
