...
==Description==
Zandalari [[warship]]s plunder the seas around this island. They ferry in soldiers and war beasts from [[Zandalar]] to bolster Lei Shen's army.
...
*{{cost|19|84|50}}
* 236000 [[XP]]
* +300 [[reputation]] with [[Sunreaver Onslaught]]
...
==Notes==
On accept:
:{{text|say|Lor'themar Theron|Ah! Champion, we were just talking about you.}}
:{{text|say|Taran Zhu|It does not matter. Taoshi's proposal is too dangerous.}}
:{{text|say|Lor'themar Theron|The sheer audacity of the plan is exactly what intrigues me. If we breech the shipyard, we will deprive the mogu of further Zandalari reinforcements.}}
:{{text|say|Taoshi|Champion, hear me out: We strike the shipyard at night, using this magnificent beast you have tamed.}}
:{{text|say|Taoshi|Once inside, we sabotage the Zandalari ship. In the chaos, we will slip into the courtyard and open the gates from within.}}
:{{text|say|Lor'themar Theron|Surely you agree that decisive action wins wars, Lord Zhu.}}
:{{text|say|Taran Zhu|Very well, Taoshi. If our champion here agrees, the mission may proceed.}}
:{{text|say|Taoshi|Thank you, Lord Zhu. I will not let you down.}}
:{{text|say|Taoshi|Speak with me when you are ready.}}
...
===Stage 1: Blending In===
[[File:A Bold Idea 1 - Taoshi and Thunderwing.jpg|thumb|Taoshi and Thunderwing]]
[[File:A Bold Idea 1 - The doomed patrol.jpg|thumb|The doomed patrol]]

:''Ride Thunderwing to scout Stormsea Landing from the air.''
*Intercept the Zandalari Patrol {{co|67.9|45.5|Isle of Thunder||1}}
Step a few yards closer to Taoshi and Thunderwing:
:{{text|say|Taoshi|I count six... no, seven guards on patrol in the sky.}}
:{{text|say|Taoshi|One of them flies higher than the others... He loops far out over the water - alone. He is over-extending. That is our in.}}
:{{text|say|Taoshi|We will neutralize him and take his route. Let's go!}}

Hop on. Taoshi will take the skyscreamer northward and attack the over-reaching guard:
:{{text|say|Taoshi|Just a little closer...}}
:{{text|say|Taoshi|Hyah!}}

===Stage 2: Path of Smoke===
[[File:A Bold Idea 2 - Clearing a path.jpg|thumb|The path to clear]]

:''Drop smoke bombs on sentry totems to deactivate them.''
*Sentry Totems deactivated x10
:{{text|say|Taoshi|The Zandalari are more cautious than I thought. Look down there - swarming with patrols.}}
:{{text|say|Taoshi|And their shaman have laid out a network of sentry totems.}}
:{{text|say|Taoshi|One of these smoke bombs will blind a sentry totem.}}
:{{text|say|Taoshi|Clear a path from the ship to the gate at the upper level - we will need to cross on foot.}}
:{{text|say|Taoshi|We cannot circle up here for long. Do what you can while I plan our next move.}}
...
:{{text|yell|Shan Bu|Awaken, Hu'seng! The docks are your responsibility. See that none pass his majesty's gates.}}
:{{text|say|Hu'seng the Gatekeeper|The Thunder King wills it; it shall be done.}}

While on Thunderwing, the champion has access to one ability:
*{{abilities|Smoke Bomb|range=200|Throws a smoke bomb that will blind a Zandalari sentry totem, allowing you to sneak past on foot.}}
...
[[File:A Bold Idea 3 - Neutralizing guards.jpg|thumb|Neutralizing guards]]
[[File:A Bold Idea 3 - Trapping siege weapons.jpg|thumb|Trapping siege weapons]]

:''Knock out the crew members marked by Taoshi and sneak to the siege weapons at the front of the ship.''
*[[Veteran Wingrider|Marked crew members]] neutralized x7
*Siege weapons trapped by Taoshi x4
:{{text|say|Taoshi|Our time is up. We need to get aboard that ship.}}
:{{text|say|Taoshi|We should sabotage the siege weapons toward the bow. Then we will go below decks and find the captain.}}
:''Taoshi lands Thunderwing on deck astern, portside.''
:{{text|say|Taoshi|Easy now... Get in close and incapacitate them.}}
:{{text|bossemote|Taoshi nods towards the crewman on the right. Sneak up behind him to knock him out!}}
...
:{{text|say|Taoshi|Here! Into the smoke!}}
...
:{{text|say|Taoshi|There will be a very unpleasant surprise waiting for the next troll who disturbs these. Let's keep moving.}}
...
===Stage 4: Wetwork===
[[File:A Bold Idea 4 - Taoshi and Halu'kal.jpg|thumb|Taoshi and Halu'kal]]

:''Head below decks and assassinate Captain Halu'kal.''
*[[Captain Halu'kal]] slain {{co|67.1|47.4|Isle of Thunder||1}}
...
:{{text|bossemote|Taoshi motions at Captain Halu'kal, then draws a finger across her neck.}}

Follow Taoshi forward, then get within range of Halu'kal and attempt to kill him:
:{{text|emote|Captain Halu'kal snores peacefully.}}
:{{text|say|Captain Halu'kal|Hm-wha? Stowaways!}}
...
Finish him off:
:{{text|say|Captain Halu'kal|You never get outta here... alive.}}

===Stage 5: Keep Quiet===
[[File:A Bold Idea 5 - Keep Quiet.jpg|thumb|Dodge the patrols]]
[[File:A Bold Idea 5 - Hu'seng.jpg|thumb|{{NPC||Hu'seng the Gatekeeper}}]]
[[File:A Bold Idea 6 - Hu'seng and Taoshi.jpg|thumb|Hu'seng and Taoshi]]

:''Sneak across the shipyard and up the hill to reach Hu'seng the Gatekeeper.''
*[[Hu'seng the Gatekeeper]] located {{co|59.2|44.6|Isle of Thunder||1}}
:{{text|say|Taoshi|Not as quiet as I would prefer, but it works.}}
:''Taoshi makes her way to the exit below deck.''
:{{text|say|Taoshi|The courtyard gate is directly up that hill.}}
:{{text|say|Taoshi|Remember to stay clear of those sentry totems.}}

Taoshi will tag along beside the adventurer. Assuming a decent path was made, move along it to get up the hill toward the gate. [[Zandalari Spirit-Twister]]s and [[Zandalari Beast Handler]]s lead [[Zandalari Conscript]]s in patrols of the grounds. Steer clear of the patrols and also of the blue circles denoting the range of the sentry totems.
...
:{{text|say|Taoshi|Sounds like they found our little present.}}

Keep moving up the hill and get close to Hu'seng:
:{{text|yell|Hu'seng the Gatekeeper|Enough hiding, little ones!}}

===Stage 6: Light Up the Night===
[[File:A Bold Idea 6 - Chained.jpg|thumb|Chained]]
[[File:A Bold Idea 6 - Lightning Storm.jpg|thumb|Lightning storm]]

:''Slay Hu'seng the Gatekeeper and recover his key.''
*[[Hu'seng the Gatekeeper]] slain {{co|59.2|44.6|Isle of Thunder||1}}
*[[Gatekeeper's Orb]]
:{{text|say|Hu'seng the Gatekeeper|There is no escape now. The only way out is through me!}}
:{{text|say|Taoshi|Through you, is it? I think we can manage that.}}
:{{text|say|Taoshi|Would you prefer we go through the belly, or the ribcage?}}
...
Finish Hu'seng off:
:{{text|say|Hu'seng the Gatekeeper|None... shall...}}
:{{text|say|Taoshi|Well fought! Now - the gates. Before the thunder king's entire army comes down on us!}}
Loot the [[Gatekeeper's Orb]] from Hu'seng's corpse.

===Final Stage: Breaking Out===
[[File:A Bold Idea 7 - Breaking out.jpg|thumb|Open the gate]]

:''Use the Gatekeeper's Orb to open the gate to the Bloodied Crossing.''
*Gate opened {{co|58.6|42.9|Isle of Thunder||1}}
Tollow Taoshi up the steps to the [[Bloodied Crossing]] and use the orb on the Deactivated Access Generator.

This completes the "Assault the Shipyard" portion of [[Isle of Thunder (achievement)]].

:''The gates slam open!''
:{{text|yell|Scout Captain Elsia|Rangers - shatter the hinges. Wedge the doors open!}}
:{{text|say|Scout Captain Elsia|Your plan worked! The two of you accomplished the work of an army.}}
:{{text|say|Taoshi|The fighting skills of my companion are quickly becoming legendary among the Shado-Pan.}}
:{{text|say|Scout Captain Elsia|The Regent Lord will want a full report. Let's get you back to camp - you have earned a rest.}}
...
==Progression==
{{Sunreaver Onslaught progression}}
...
[[Category:Pandaria quest scenarios]]
[[Category:Sunreaver Onslaught quests]]